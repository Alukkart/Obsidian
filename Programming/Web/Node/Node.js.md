...
- вспомогательные инструменты для клиентских приложений — [системы сборки](https://doka.guide/tools/bundlers/), [распространения пакетов](https://doka.guide/tools/package-managers/), серверы разработки, редакторы кода и [системы статического анализа](https://doka.guide/tools/static-analysis/);
