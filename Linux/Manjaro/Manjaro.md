...
2. Репозитории: AUR , Arch, Flatpack позволяют поставить что угодно.
3. Отличный пакетный менеджер с встроенной поддержкой AUR и Flatpack. Так же пакентный менеджер показывает все зависимости пакетов и расположения их файлов, что позволяет полностью в ручную удалить пакет, если менеджер не хочет этого делать.
